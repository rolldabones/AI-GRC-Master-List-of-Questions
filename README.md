# AI-GRC-Master-List-of-Questions
Here is a Master List of Minimum Questions that, if answered, enables the AI GRC Copilot custom GPT to generate the full set of 30 canonical AI GRC artifact drafts.

Master List of Minimum Questions for AI GRC Copilot (30 Canonical Artifacts)
...
If you cannot answer something, you can respond “Unknown/TBD” and the AI GRC Copilot will draft with explicit placeholders and an open-items list.
